...
public class LocationDataAccessImplTests extends AbstractDataAccessImplTests<Location> {
     ...
     * 
     * @see
     * com.springinpractice.ch11.service.impl.AbstractEntityServiceImplTests
     * #getService()
     */
    @Override
     ...
     */
    @Override
    protected EntityManager getRepository() {
        return em;
    }
    ...
    public void setUp() throws Exception {
        ...
        // when(em.find(locationDao.getClass(),
        // anyLong())).thenReturn(location);
