...
public class WeatherClient {
    ...
    /**
     * Note: This constructor appends a "/" to the URL if the URL doesn't
    ...
    // return template.getForObject(getWeathersUrl() + "?format=xml",
    // Weather.WeatherListWrapper.class).getList();
    // }
